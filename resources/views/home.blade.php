...
<head>
  ...
  <title>House Rent Rwanda Dashboard</title>
      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{url('admin/view/messages')}}">View Messages</a>
            @if(Auth::user()->role == 'Admin')
            <a class="collapse-item" href="{{url('admin/view/notifications')}}">View Notifications</a>
            @endif
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; House Rent Rwanda 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
