    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <p class="mb-4">Data Table For Messages Sent to you from Clients when they clicked on a given house.</p>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    @if($view->status == 1)
                    <tr style="font-weight: bold; background-color: #DBE2E5;">
                      <td>{{$key+1}}</td>
                      <td>{{$view->full_names}}</td>
                      <td>{{$view->phone}}</td>
                      <td>{{$view->email}}</td>
                      <td>{{substr($view->message, 0, 20)}}...</td>
                      <td>
                        <a class = "btn btn-primary" href="{{url('admin/notifications/read/'.$view->id)}}">Read More</a>
                      </td>
                    </tr>
                    @else
                    <tr>
