    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Properties Tables</h1>
          <p class="mb-4">Data Table for Properties, Where you can Edit, Disable if it has been taken or Enable if it is available again</p>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$view->house_class}}</td>
                      <td>{{$view->house_type}}</td>
                      <td>{{$view->price}}</td>
                      <td>{{$view->sector}}</td>
                      <td><a href="{{url('admin/view/'.$view->id)}}" style="color: white;" class="btn btn-info">View More</a></td>
