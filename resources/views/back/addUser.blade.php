            ...
            <div class="col-lg-6">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="{{url('admin/addUser')}}"  enctype="multipart/form-data" class="user">
                    @csrf
                    <input type="text" name="family_name" placeholder="Enter Agent's Family Name...Eg: Rwabugiri, Kayonga" class="form-control{{ $errors->has('family_name') ? ' is-invalid' : '' }}" value="{{ old('email') }}" required>
                    @if ($errors->has('family_name'))
                                ...
                                @endif
                    <br/>
                    <input type="text" name="other_name" placeholder="Enter Agent's Other Name...Eg: Pascal, Bienvenue"class="form-control{{ $errors->has('other_name') ? ' is-invalid' : '' }}" value="{{ old('other_name') }}" required>
                    @if ($errors->has('other_name'))
                                ...
                                @endif
                                <br/>
                    <input type="text" name="email" placeholder="Enter Agent's Email...Eg: example@gmail.com" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{ old('email') }}" required>
                    @if ($errors->has('email
                    '))
                                    <span class="invalid-feedback" role="alert">
                                ...
                                @endif
                                <br/>
                    <input type="text" name="telephone" placeholder="Enter Agent's Telephone...Eg: 07XXXXXXXX"class="form-control{{ $errors->has('telephone') ? ' is-invalid' : '' }}" value="{{ old('telephone') }}" required>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    @if ($errors->has('sector'))
                                ...
                                @endif
                                <br/>
                                <select name="role" class="form-control{{ $errors->has('house_class') ? ' is-invalid' : '' }}" value="{{ old('house_class') }}" required>
                  ...
                  <label>Enter Front Picture</label>
                    ...
                    &nbsp; &nbsp; &nbsp; &nbsp;
                    <a href="{{url('admin/addUser')}}" class="btn btn-danger">Cancel</a>
                  </form>
